...
function loadStatsPage()
{
	...
	{//Outer for loop iterates over each row
		value1 = table.rows[row_counter].cells[2].innerHTML;
		value2 = table.rows[row_counter].cells[3].innerHTML;
		if (value1 > value2)
		{
			console.log('Win')
			console.log()
			table.rows[row_counter].cells[4].innerText = "<h1>CU Boulder</h1>";
			num_win++;
		}
	...
	document.getElementById("wins").innerHTML=num_win;
	document.getElementById("losses").innerHTML = num_los;
}
...
function loadPlayersPage()
{
	...
	{
		playerString += "<a href='#' class = 'dropdown-item' onclick='switchPlayers("+index+")'> "+  players[index].name + "</a>"
	}
